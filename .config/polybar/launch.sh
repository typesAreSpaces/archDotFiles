...
NETWORK_INTERFACE=$interface MONITOR=DP1 polybar -c ~/.config/polybar/config.ini top_bar &
NETWORK_INTERFACE=$interface MONITOR=DP1 polybar -c ~/.config/polybar/config.ini bottom_bar &
