...
_G.packer_plugins = {
  ...
  ["nvim-treesitter"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/home/jose/.local/share/nvim/site/pack/packer/opt/nvim-treesitter",
  ...
  ["telescope.nvim"] = {
    after = { "telescope-ultisnips.nvim" },
    commands = { "Telescope" },
...
vim.cmd [[au BufWinEnter * ++once lua require("packer.load")({'which-key.nvim', 'wilder.nvim', 'nvim-lsp-installer', 'nvim-treesitter', 'lualine.nvim'}, { event = "BufWinEnter *" }, _G.packer_plugins)]]
